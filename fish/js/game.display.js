game.display = {
  ...
  clearRect : function(targetLayer, x, y, width, heigth) {
      targetLayer.context2D.clearRect(targetLayer, x, y, width, heigth)
  },
    
  drawCircle : function(targetLayer,x,y,r,sAngle,eAngle,counterclockwise){
    targetLayer.context2D.beginPath();
    targetLayer.context2D.arc(x,y,r,sAngle,eAngle,counterclockwise);  
